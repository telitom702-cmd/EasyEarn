...
// [পরিবর্তন ১] এটি Render এবং Vercel উভয় প্ল্যাটফর্মে রুট লিংকে index.html দেখাবে
app.get('/', (req, res) => {
...
const connectDB = async () => {
    ...
    try {
        await mongoose.connect(config.MONGO_URI, { dbName: "telitask" });
...
// [পরিবর্তন ২] এই কোডটি অটোমেটিক বুঝে নেবে সে কোন প্ল্যাটফর্মে আছে
