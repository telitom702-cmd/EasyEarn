...
// =======================================================
const connectDB = async () => { if (mongoose.connection.readyState >= 1) return; await mongoose.connect(config.MONGO_URI); };

module.exports = async (req, res) => { await connectDB(); app(req, res); };
